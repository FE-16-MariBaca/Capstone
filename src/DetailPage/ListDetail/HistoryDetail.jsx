...
import { getHistoryDetail } from "../../redux/features/featuresDetail/historyDetailSlice";
...
const HistoryDetail = () => {
  ...
  const { data, isLoading } = useSelector((state) => state.historyDetail);
  ...
  useEffect(() => {
    ...
    dispatch(getHistoryDetail(bookId));
  }, [bookId]);
      ...
      <Row>
        ...
        <Col lg={7}>
          ...
          <div className="d-flex justify-content-end mb-5 justify-content-between">
            ...
            <Link to={`/genre/history/read/${data.id}`}>
